            ...
            <form method="POST" action="{{ route('book.update',$record->id) }}" class="kt-form kt-form--label-right" enctype="multipart/form-data">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{ $record->category }}" name="category">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-2 col-form-label">作者</label>
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{ $record->author }}" name="author">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-2 col-form-label">简介</label>
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{ $record->intro }}" name="intro">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{ $record->tags }}" name="tags">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-2 col-form-label">最新章节</label>
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{ $record->last_chapter }}" name="last_chapter">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-2 col-form-label">采集规则id</label>
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{ $record->bs_id }}" name="bs_id">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-2 col-form-label">是否完结</label>
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{ $record->finished }}" name="finished">
                        </div>
                    </div>
                </div>
