        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="{{ route('spider.index') }}" class="kt-subheader__breadcrumbs-link">列表 </a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
            ...
            <div class="kt-subheader__toolbar">
                <div class="kt-subheader__wrapper">
                    <a href="{{ route('spider.create') }}" class="btn kt-subheader__btn-primary">
                        新增
...
@section('content')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form method="POST" action="{{ route('spider.update',$record->id) }}" class="kt-form kt-form--label-right">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select class="form-control" id="exampleSelectd" name="target" readonly>
                                <spider @if($record->autoload == 'yes') selected @endif value="yes">YES</spider>
                                <spider @if($record->autoload == 'no')  selected @endif value="no">NO</spider>
                            </select>
                        </div>
                    </div>
                </div>
